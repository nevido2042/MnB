...
AMnBGameMode::AMnBGameMode()
{
	...
	{
		ConstructorHelpers::FClassFinder<UClass>Finder(TEXT("/Script/Engine.Blueprint'/Game/MyAssets/VR/BP_VRCharacter.BP_VRCharacter_C'"));
		if (Finder.Class)
		{
	...
	{
		ConstructorHelpers::FClassFinder<UClass>Finder(TEXT("/Script/Engine.Blueprint'/Game/MyAssets/VR/BPC_VR.BPC_VR_C'"));
		if (Finder.Class)
		{
